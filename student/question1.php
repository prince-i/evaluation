...
if(isset($_POST['submit']))
{
    ...
    $createCommentQuery = "INSERT INTO 
                                `pandemic_com` (subj_id, prof_id, sec_id, com_ans) 
                             VALUES 
	...
	$conn = mysqli_query($connection,"select * from pandemic_stud")or die ("query 2 incorrect.......");

	while(list($question_id,$questionnaire) = mysqli_fetch_array($conn))
	{
		$evl_val=$_POST["radio$question_id"];
		mysqli_query($connection,"INSERT INTO `evaluation_pandemic`(`stud_id`,`prof_id`,`subj_id`,`sec_id`,`ques_id`, `ques_ans`) VALUES ('$stud_id','$prof_id','$subj_id','$sec_id','$question_id','$evl_val')") or die (mysqli_error($connection));
...
<form action="question1.php" name="form" method="post" class="form-horizontal">
	     <!-- Begin Page Content -->
                <div class="container-fluid">


<h1 class="h2 mb-2 text-gray-800">PANDEMIC EVALUATION</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
								<!--ADD-->
<h5 class="m-0 font-weight-bold text-dark">Survey Questionnaire</h5><br>

<?php 
$conn=mysqli_query($connection,"select id,module, survey, deleted_at from survey where module='MODULAR' AND deleted_at='OPEN'")or die ("query 2 incorrect.......");
...
<b><h5>Direction: Please rate the level of your satisfaction regarding this course: 
<br></b></h5>
...
<!-- FOR QUESTIONS -->
<?php 
$conn=mysqli_query($connection,"select * from pandemic_stud WHERE deleted_at='OPEN'")or die ("query 2 incorrect.......");
