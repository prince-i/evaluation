	     ...
	     <!-- Begin Page Content -->
                ...
                <?php  if ( $student == 'PANDEMIC' ) { ?>	
                    ...
                    0 ?>
                            ...
                            <?php
                                $question=mysqli_query($connection,"select eval_id,questionnaire,ques_ans,evaluation_pandemic.ques_id from ques_stud
                                inner join evaluation_pandemic on evaluation_pandemic.ques_id = ques_stud.ques_id 
                                        ...
                                        <div class="card" style="width: 18rem;">
                                            <img  src="<?= $teacher_row_run['picture'] ?>"width="100px" height="300px" class="card-img-top"/>
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text" style="color: black;font-weight: bold;"><?php echo $row_subject['subj_name'] ?></p>
                                                    <button class="btn btn-danger"><a style="color:white;" href="question1.php?stud_id=<?php echo $user_id; ?>&prof_id=<?php echo $teacher_row_run['techId'] ?>&subj_id=<?php echo $teacher_row_run['subId'] ?>&sec_id=<?php echo $teacher_row_run['sec_id'] ?> "><i class="fas fa-times-circle"></i> EVALUATE</a></button>
                                                </div>
                                        </div>
                                    </div>
            ...
            <?php } ?>
                <input  type="hidden" name="teacher"  value="student">
                                ...
                                <?php 
                                    ...
                                    elseif ($student == 'FACE' )
                                    { 
                                        echo "<h2 align='center'><br> EVALUATION HERE IN PANDEMIC CLASS IS NOT AVAILABLE. PLASE PROCEED TO THE FACE TO FACE EVALUATION. THANKYOU</h2>";
                                    }
                                    else 
                                    { 
