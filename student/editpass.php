...
$query=mysqli_query($connection,"select password from student where stud_id='$user_id'")or die ("query 1 incorrect.......");
...
mysqli_query($connection,"update student set password='$password' where stud_id='$user_id'")or die("Query 2 is inncorrect..........");
