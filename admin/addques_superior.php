...
if (isset($_POST['save'])) {
    ...
    $result = mysqli_query($con,"INSERT INTO $table (questionnaire)
	VALUES ('$questionnaire')") or die('Error In Session');
    
    echo '<meta http-equiv="refresh" content="1;url=ques_superior.php">';
}
	...
	<!-- Content Wrapper -->
      ...
      <!-- Select Eval from Eval Table -->
		   ...
		   <br>
			  ...
			  <a class="btn btn-secondary btn-sm" href="ques_superior.php">Cancel</a>
      </div>
	  </form>
