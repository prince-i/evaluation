...
header("location: classroomobs.php");
mysqli_close($con);
}
...
<input type="submit" class="btn btn-secondary btn-sm" name="add_professor_to_prof" value="Select Observer" id="submit">
...
$qry2=mysqli_query($con,"select * from assign_obs
INNER JOIN prof_stud ON prof_stud.prof_id = assign_obs.dept_id where assign_obs.prof_id='$prof_id'");
...
<input type="submit" class="btn btn-secondary btn-sm" name="unset_prof_professor" value="Remove Observer" id="submit">
