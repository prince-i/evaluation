...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
	     ...
	     <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h2 mb-2 text-gray-800">EVALUATION RESULT FOR MODULAR</h1>
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="card-body" id="forPrint">
                            ...
                            <div class="table-responsive">
                                <!--BACK-->
                                    <a class="btn btn-primary" href="student_evalresult1.php" id="backbtn">
    ...
    <h5 style="color: black"><b> &nbsp; SUBJECT NAME  :</b> <?php echo $subject_name['subj_name'] ?></h5>
                            <br>                 
                                               </div>
<div class="col-sm-6" style="background-color:lightgray;"><br>
     ...
     <h5 style="color: black"><b> &nbsp; COURSE    : </b><?php echo $program_name['course_code'] ?></h5>  <br></div>
  </div>  
  <div class="row">
                                            ...
                                            <br>
                                                ...
                                                <?php
                                                        $sql1="select count(distinct student.stud_id) AS total 
                                                        from student inner join subject on student.year_id=subject.year_id INNER JOIN
                                                        evaluation_pandemic ON evaluation_pandemic.stud_id=student.stud_id
...
<?php
    ...
    $query = "SELECT 
                evaluation_pandemic.ques_id,
                pandemic_stud.questionnaire,
                evaluation_pandemic.eval_id,
                SUM(evaluation_pandemic.ques_ans) AS total_evaluation_score,
                FORMAT(SUM(evaluation_pandemic.ques_ans) / COUNT(evaluation_pandemic.stud_id), 0) AS average,
                COUNT(evaluation_pandemic.stud_id) AS number_of_students_evaluated
            FROM 
            pandemic_stud 
            INNER JOIN 
            evaluation_pandemic 
            ON 
            evaluation_pandemic.ques_id = pandemic_stud.ques_id 
            WHERE 
            evaluation_pandemic.prof_id = $prof_id 
            AND 
            evaluation_pandemic.subj_id = $subjectID 
            GROUP BY
            evaluation_pandemic.ques_id,	
            evaluation_pandemic.ques_ans
    ";
    ...
    foreach ($filtered_row_question_list as $filtered_row_questions) 
    {
        ...
        foreach ([1, 2, 3, 4] as $max_score) // 2
        {
        ...
        $average_evaluation_score = number_format($total_evaluation_score / ($total_number_of_students * 4)*100, 1);
