        ...
        <div id="content-wrapper" class="d-flex flex-column">
	     ...
	     <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h2 mb-2 text-gray-800">SUPERIOR EVALUATION RESULT </h1>
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="card-body" id="forPrint">
                            ...
                            <div class="table-responsive">
							 <!--BACK-->
                             <a class="btn btn-primary" href="superior_evalresult.php"  id="backbtn">
...
<?php
    ...
    $query = "SELECT 
                ...
                ques_direc.questionnaire,
                evaluation_superior.eval_id,
                SUM(evaluation_superior.ques_ans) AS total_evaluation_score,
                FORMAT(SUM(evaluation_superior.ques_ans) / COUNT(evaluation_superior.prof_id), 0) AS average,
                COUNT(evaluation_superior.prof_id) AS number_of_students_evaluated
            FROM 
            ques_direc 
            INNER JOIN 
            evaluation_superior 
            ...
            WHERE 
            evaluation_superior.prof_id = $prof_id 
            
            GROUP BY
            evaluation_superior.ques_id,	
            evaluation_superior.ques_ans
    ";
