...
if (isset($_POST['save'])) {
    ...
    $result = mysqli_query($con,"INSERT INTO $table (course_code,dept_id, course_name, deleted_at)
	VALUES ('$course_code','$dept_id','$course_name', 'OPEN')") or die('Error In Session');
