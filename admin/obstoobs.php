...
mysqli_query($con,"insert into assign_obs(prof_id,dept_id) values('".$prof_id."','".$resv."')") or die (mysqli_error($con));
}
...
foreach($_POST["professor_unset"] as $resv)
    {
$remove_professor_from_teacher = "Delete from assign_obs where prof_id ='".$prof_id."' AND dept_id = '".$resv."'";


mysqli_query($con,$remove_professor_from_teacher) or die (mysqli_error($con));
}

header("location:obs_to_obs.php?prof_id=".$prof_id."");
mysqli_close($con);
}
        ...
        <div id="content-wrapper" class="d-flex flex-column">
	     ...
	     <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h2 mb-2 text-gray-800">SELECT OBSERVER</h1>
                    

                    <!-- COURSE TABLE -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Select Observer Faculty Member Table</h6>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
								<!--ADD-->
							<form action="obstoobs.php" name="form" id="form_teach" method="post" class="form-horizontal" style="margin-left:100px">
...
<?php                  
$qry=mysqli_query($con,"select * from `prof_stud`");
while($row=mysqli_fetch_array($qry))
{
    $qry_checking=mysqli_query($con,"select * from `assign_obs` where prof_id='".$_REQUEST['prof_id']."' AND dept_id='".$row['prof_id']."'");
...
<input type="submit" class="btn btn-secondary btn-sm" name="add_professor_to_prof" value="Assign Professor" id="submit">
...
<div class="col-md-9">
  ...
  <hr style="width:100%; border: 2px solid; color:gray;">
    <b style="font-size:20px;">Professor Assigned To <?php echo $row_teacher['prof_lname']; ?>, <?php echo $row_teacher['prof_fname']; ?></b>
   <hr style="width:100%; border: 2px solid; color:gray;">
...
$qry2=mysqli_query($con,"select * from assign_obs where prof_id='$prof_id'");
...
<input type="submit" class="btn btn-secondary btn-sm" name="unset_prof_professor" value="Remove Professor" id="submit">

<a class="btn btn-secondary btn-sm" href="classroomobs.php" style="color: white">Cancel</a> 
    </div></div>
</form>
