...
if (isset($_POST['save'])) {
    ...
    echo '<meta http-equiv="refresh" content="1;url=ftof_survey.php">';
}
	...
	<!-- Content Wrapper -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Add new Instruction for Face to Face</h6>
                        </div>
     ...
     <textarea class="form-control" name ="survey" style=" height:100px ;" placeholder="Instruction: " required></textarea>
		   ...
		   <br>
			  ...
			  <a class="btn btn-secondary btn-sm" href="ftof_survey.php">Cancel</a>
      </div>
	  </form>
