<div class="modal fade" id="editquesstud<?php echo $row['ques_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <form method="POST" action="editques.php?questionnaire=<?php echo $row['ques_id']; ?>" enctype="multipart/form-data">
