        ...
        <div id="content-wrapper" class="d-flex flex-column">
	     ...
	     <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h2 mb-2 text-gray-800">CLASSROOM OBSERVATION EVALUATION RESULT </h1>
                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="card-body" id="forPrint">
                            ...
                            <div class="table-responsive">
							 <!--BACK-->
                             <a class="btn btn-primary" href="classroomobs_evalresult.php" id="backbtn">
...
<?php
    ...
    $query = "SELECT 
                ...
                ques_obs.questionnaire,
                evaluation_obs.eval_id,
                SUM(evaluation_obs.ques_ans) AS total_evaluation_score,
                FORMAT(SUM(evaluation_obs.ques_ans) / COUNT(evaluation_obs.prof_id), 0) AS average,
                COUNT(evaluation_obs.prof_id) AS number_of_students_evaluated
            FROM 
            ques_obs 
            INNER JOIN 
            evaluation_obs 
            ON 
            evaluation_obs.ques_id = ques_obs.ques_id 
            WHERE 
            evaluation_obs.prof_id2 = $prof_id 
            
            GROUP BY
            evaluation_obs.ques_id,	
            evaluation_obs.ques_ans
    ";
