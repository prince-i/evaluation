                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Evaluation Result for Faculty Member</h6>
                        </div>
<form action="classroomobs_result.php" method="post">
                        <div class="card-body">
...
<select class="form-control" name="department" onchange="select_professor_ajax(this.value)" required>
...
<script type="text/javascript">
    ...
    function select_professor_ajax(dept_id){
        //alert(dept_id);exit;
        $.ajax({

            url: 'ajax_select_professor.php',
