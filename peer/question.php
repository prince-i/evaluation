...

{
	...
	$conn = mysqli_query($connection,"select * from ques_peer")or die ("query 2 incorrect.......");

	while(list($question_id,$ques_eval,$questionnaire) = mysqli_fetch_array($conn))
	{
		$evl_val=$_POST["radio$question_id"];
		mysqli_query($connection,"INSERT INTO `evaluation_peer`(`prof_id`,`prof_id2`,`ques_id`, `ques_ans`) VALUES ('$user_id','$prof_id2','$question_id','$evl_val')") or die (mysqli_error($connection));
...
<?php 
$conn=mysqli_query($connection,"select id,module, survey, deleted_at from survey where module='PEER TO PEER' AND deleted_at='OPEN'")or die ("query 2 incorrect.......");
...
<a class="btn btn-danger" href="evaluation.php">CANCEL</a> 
<hr><hr>
