...
$query=mysqli_query($connection,"select password from prof_stud where prof_id='$user_id'")or die ("query 1 incorrect.......");
...
mysqli_query($connection,"update prof_stud set password='$password' where prof_id='$user_id'")or die("Query 2 is inncorrect..........");
