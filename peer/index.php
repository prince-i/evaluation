...
?>
<?php
    $query=mysqli_query($connection,"SELECT dept_name, prof_fname,  prof_lname, status ,username, password, email, dept_code, number FROM prof_stud INNER JOIN
    department on department.dept_id=prof_stud.dept_id where prof_id
        ...
        <div id="content-wrapper" class="d-flex flex-column">
	     ...
	     <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h2 mb-2 text-gray-800"><?php echo $lname;?>, <?php echo $fname;?></h1>
                    <h6>Department : <?php echo $dept_name;?> (<?php echo $dept_code;?>) </h6><br>
					<h6><b> <tt style="color: green; font-size:17px;">&emsp;&emsp; <i class="fas fa-building"></i> Status  </b>  </tt>&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp; <?php echo $status;?></h6>
