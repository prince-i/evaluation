<?php
    ...
    $department_query = "SELECT 
                        ...
                        INNER JOIN 
                            assign_obs 
                        ON
                            prof_stud.prof_id=assign_obs.prof_id 
                        WHERE 
                        assign_obs.dept_id ='$user_id' ";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
	     ...
	     <!-- Begin Page Content -->
                ...
                <?php
                    ...
                    list($obs) = mysqli_fetch_array($main);
                ?> 
                <?php  if ( $obs == 'ON' ) { ?>		
                 <!-- Page Heading -->
                    
                    <h1 class="h2 mb-2 text-gray-800">CLASSROOM OBSERVATION EVALUATION</h1>
            ...
            <?php while ($row_subject1 = mysqli_fetch_array($department)) { ?>
                    ...
                    <?php
                        ...
                        questionnaire,
                        ques_ans,
                        evaluation_obs.ques_id
                    FROM 
                        ques_direc
                    INNER JOIN 
                        evaluation_obs 
                    ON 
                        evaluation_obs.ques_id = ques_direc.ques_id 
                    WHERE
                        prof_id = $user_id
                    AND
                        prof_id2 = $tech_id ";
                        ...
                        { ?>
                                    <div class="col-sm-6 col-md-4 col-lg-3 mb-2 mr-5">
                                        <div class="card" style="width: 18rem;">
                                            <img  src="<?= $row_subject1['picture'] ?>"width="100px" class="card-img-top"/>
                                                <div class="card-body">
                                                    <h5 class="card-title" style="color: black; text-transform: uppercase; font-weight: bold;"><?php echo $row_subject1['prof_lname'];?>, <?php echo $row_subject1['prof_fname'];?> </a></h5>
                                                    <p class="card-text" style="color: black;font-weight: bold;" >Faculty Member</p>
                                                    <button class="btn btn-danger"><a style="color:white;" href="question_obs.php?prof_id=<?php echo $user_id; ?>&prof_id=<?php echo $row_subject1['techId'] ?>"><i class="fas fa-times-circle"></i> EVALUATE</a></button>
