<?php
    ...
    $department_query = "SELECT 
                        ...
                        INNER JOIN 
                            superior 
                        ON 
                            superior.dept_id=prof_stud.dept_id
                        INNER JOIN 
                            department 
                        ON 
                            prof_stud.dept_id=department.dept_id
                        
                        WHERE 
                            superior.super_id = $user_id";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
	     ...
	     <!-- Begin Page Content -->
                ...
                <?php
                    ...
                    list($action) = mysqli_fetch_array($main);
                ?> 
                <?php  if ( $action == 'ON' ) { ?>		
                 <!-- Page Heading -->
            ...
            <?php while ($row_subject1 = mysqli_fetch_array($department)) { ?>
                    ...
                    <?php
                        ...
                        $dept_id = $row_subject1['deptId'];

                        $question_query = "SELECT 
                            eval_id,
                            questionnaire,
                            ques_ans,
                            evaluation_superior.ques_id 
                        FROM 
                            ques_direc
                        INNER JOIN 
                            evaluation_superior 
                        ON 
                            evaluation_superior.ques_id = ques_direc.ques_id 
                        WHERE 
                            prof_id = $tech_id 
                        AND 
                            dept_id = $dept_id 
                                            ...
                                            <div class="card" style="width: 18rem;">
                                                <img src="<?= $row_subject1['picture'] ?> "width="100px"class="card-img-top"/>
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text" style="color: black;font-weight: bold;"><?php echo $row_subject1['dept_name'] ?></p>
                                        ...
                                        <div class="card" style="width: 18rem;">
                                            <img  src="<?= $row_subject1['picture'] ?>"width="100px" class="card-img-top"/>
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text" style="color: black;font-weight: bold;" ><?php echo $row_subject1['dept_name'] ?></p>
                                                    <button class="btn btn-danger"><a style="color:white;" href="question.php?super_id=<?php echo $user_id; ?>&prof_id=<?php echo $row_subject1['techId'] ?>&dept_id=<?php echo $row_subject1['deptId'] ?>"><i class="fas fa-times-circle"></i> EVALUATE</a></button>
